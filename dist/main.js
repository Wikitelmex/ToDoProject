...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_addelement_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/addelement.js */ \"./src/modules/addelement.js\");\n/* harmony import */ var _modules_statusupdates_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/statusupdates.js */ \"./src/modules/statusupdates.js\");\n/* harmony import */ var _modules_crudtask_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/crudtask.js */ \"./src/modules/crudtask.js\");\n\n\n\n\n\nconst todoul = document.querySelector('.todo-elements');\n\nlet tasksData = [];\n\nwindow.insertTaskArray = () => {\n  todoul.innerHTML = '';\n  (0,_modules_addelement_js__WEBPACK_IMPORTED_MODULE_1__.insertTaskArray)(tasksData);\n};\n\nwindow.onEnter = (e) => {\n  if (e.keyCode === 13) {\n    if (e.target.value === null || e.target.value.match(/^ *$/) !== null) {\n      return;\n    }\n\n    (0,_modules_crudtask_js__WEBPACK_IMPORTED_MODULE_3__.insertOnArray)(e.target.value, tasksData);\n    (0,_modules_statusupdates_js__WEBPACK_IMPORTED_MODULE_2__.saveData)(tasksData);\n    window.insertTaskArray(tasksData);\n\n    e.target.value = '';\n  }\n};\n\nwindow.onAddButtonClick = () => {\n  const floatingInput = document.querySelector('#floatingInput');\n  if (floatingInput.value === null || floatingInput.value.match(/^ *$/) !== null) {\n    return;\n  }\n\n  (0,_modules_crudtask_js__WEBPACK_IMPORTED_MODULE_3__.insertOnArray)(floatingInput.value, tasksData);\n  (0,_modules_statusupdates_js__WEBPACK_IMPORTED_MODULE_2__.saveData)(tasksData);\n  window.insertTaskArray(tasksData);\n\n  floatingInput.value = '';\n  floatingInput.focus();\n};\n\nwindow.onChangeCheck = (e) => {\n  (0,_modules_statusupdates_js__WEBPACK_IMPORTED_MODULE_2__.stateTask)(e, tasksData);\n  (0,_modules_statusupdates_js__WEBPACK_IMPORTED_MODULE_2__.saveData)(tasksData);\n};\n\nwindow.onEditable = (elementId) => {\n  (0,_modules_crudtask_js__WEBPACK_IMPORTED_MODULE_3__.onEditable)(elementId);\n};\n\nwindow.onNonEditable = (elementId) => {\n  const editable = document.querySelector(`#editable${elementId}`);\n  (0,_modules_crudtask_js__WEBPACK_IMPORTED_MODULE_3__.updateFromArray)(elementId, tasksData, editable.value);\n  (0,_modules_statusupdates_js__WEBPACK_IMPORTED_MODULE_2__.saveData)(tasksData);\n  setTimeout(() => {\n    (0,_modules_crudtask_js__WEBPACK_IMPORTED_MODULE_3__.onNonEditable)(elementId);\n  }, 200);\n};\n\nwindow.onRemoveButtonClick = (elementId) => {\n  (0,_modules_crudtask_js__WEBPACK_IMPORTED_MODULE_3__.removeFromArray)(elementId, tasksData);\n  (0,_modules_crudtask_js__WEBPACK_IMPORTED_MODULE_3__.orderArray)(tasksData);\n  window.insertTaskArray(tasksData);\n  (0,_modules_statusupdates_js__WEBPACK_IMPORTED_MODULE_2__.saveData)(tasksData);\n};\n\nwindow.onClearAllCompleted = () => {\n  tasksData = tasksData.filter((word) => word.completed === false);\n  (0,_modules_crudtask_js__WEBPACK_IMPORTED_MODULE_3__.orderArray)(tasksData);\n  window.insertTaskArray(tasksData);\n  (0,_modules_statusupdates_js__WEBPACK_IMPORTED_MODULE_2__.saveData)(tasksData);\n};\n\nwindow.onload = () => {\n  const d = (0,_modules_statusupdates_js__WEBPACK_IMPORTED_MODULE_2__.loadData)();\n  if (d != null) {\n    tasksData = d;\n  }\n  window.insertTaskArray(tasksData);\n};\n\n\n//# sourceURL=webpack://todolist/./src/index.js?");
